...
func (s *FlatMapIterableStream[T, R]) GetErrorConsumer() runtime.RuntimeStream {
	return nil
}

func (s *FlatMapIterableStream[T, R]) GetValueType() reflect.Type {
	var r R
	return reflect.TypeOf(&r).Elem()
}

func (s *FlatMapIterableStream[T, R]) GetKeyType() reflect.Type {
	return nil
}
