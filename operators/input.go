...
func (s *InputStream[T, R, E]) FunctionImplementation() interface{} {
	return nil
}

func (s *InputStream[T, R, E]) GetErrorConsumer() runtime.RuntimeStream {
	return s.errorConsumer
}

func (s *InputStream[T, R, E]) GetValueType() reflect.Type {
	var t T
	return reflect.TypeOf(&t).Elem()
}

func (s *InputStream[T, R, E]) GetKeyType() reflect.Type {
	return nil
}
...
func (s *InputKVStream[K, V, R, E]) FunctionImplementation() interface{} {
	return nil
}

func (s *InputKVStream[K, V, R, E]) GetErrorConsumer() runtime.RuntimeStream {
	return s.errorConsumer
}

func (s *InputKVStream[K, V, R, E]) GetValueType() reflect.Type {
	var kv datastruct.KeyValue[K, V]
	return reflect.TypeOf(&kv).Elem()
}

func (s *InputKVStream[K, V, R, E]) GetKeyType() reflect.Type {
	var k K
