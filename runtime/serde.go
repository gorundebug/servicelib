...
type StreamKeyValueSerde[T any] interface {
    ...
    GetKeySerializer() Serializer
    GetValueSerializer() Serializer
}
...
func (s *streamKeyValueSerde[K, V]) GetKeySerializer() Serializer {
    return s.serdeKey
}

func (s *streamKeyValueSerde[K, V]) GetValueSerializer() Serializer {
    return s.serdeValue
}
