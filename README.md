...
Service Architect is a visual designer for distributed systems. You draw a graph of services, pipelines, and connections. The designer generates a complete Go project. That generated project uses **servicelib** as its runtime.
...
Execution traces run through the exact nodes defined in the graph. No separate trace infrastructure. No configuration.
...
| [Example project](https://github.com/gorundebug/cppexample) | Sample project generated by Service Architect |
